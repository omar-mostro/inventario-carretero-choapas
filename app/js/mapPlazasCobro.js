...
['<div id="fixedWindow">' +
 '<img src="img/PlazasCobro/1.JPG" alt="Imagen de Plazas de Cobro">' +
'<h4 class="fixedWindowTitle titlePlazasCobro">Relación de Plazas de Cobro :KM 15+000 AL 20+000 </h4>' +
'<h5 class="subTitle"> Tipo </h5> <p class="description"> CASETA DE COBRO </p>' +
'<h5 class="subTitle"> Cadenamiento </h5> <p class="description"> 16+690.00 </p>' +
'<h5 class="subTitle"> Cuerpo </h5> <p class="description">ÚNICO </p>' +
'<h5 class="subTitle"> Número de Cabinas </h5> <p class="description"> 10 </p>' +
'<h5 class="subTitle"> Condición </h5> <p class="description"> FUNCIONAL </p>' +
'<h5 class="subTitle"> Latitud_Ini </h5> <p class="description">17° 56  41.52"N</p>' +
'<h5 class="subTitle"> Longitud_Ini </h5> <p class="description"> 94° 10  20.28"W</p>' +
'<h5 class="subTitle"> Altitud </h5> <p class="description"> 62.15 </p>' +
...
['<div id="fixedWindow">' +
 '<img src="img/PlazasCobro/2.JPG" alt="Imagen de Plazas de Cobro">' +
'<h4 class="fixedWindowTitle titlePlazasCobro">Relación de Plazas de Cobro :KM 110+000 AL 115+000 </h4>' +
'<h5 class="subTitle"> Tipo </h5> <p class="description"> CASETA DE COBRO </p>' +
'<h5 class="subTitle"> Cadenamiento </h5> <p class="description"> 112+700 </p>' +
'<h5 class="subTitle"> Cuerpo </h5> <p class="description">ÚNICO </p>' +
'<h5 class="subTitle"> Número de Cabinas </h5> <p class="description"> 6 </p>' +
'<h5 class="subTitle"> Condición </h5> <p class="description"> FUNCIONAL </p>' +
'<h5 class="subTitle"> Latitud_Ini </h5> <p class="description">17° 20  56.56"N</p>' +
'<h5 class="subTitle"> Longitud_Ini </h5> <p class="description"> 93° 35  11.27"W</p>' +
'<h5 class="subTitle"> Altitud </h5> <p class="description"> 391.86 </p>' +
'<a class="hvr-bounce-to-right" onClick="back()"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar.</a>'+
'</div>', 
17.34904444,
-93.58646389,
...
['<div id="fixedWindow">' +
 '<img src="img/PlazasCobro/3.JPG" alt="Imagen de Plazas de Cobro">' +
'<h4 class="fixedWindowTitle titlePlazasCobro">Relación de Plazas de Cobro :KM 180+000 AL 185+000 </h4>' +
'<h5 class="subTitle"> Tipo </h5> <p class="description"> CASETA DE COBRO </p>' +
'<h5 class="subTitle"> Cadenamiento </h5> <p class="description"> 182+000 </p>' +
'<h5 class="subTitle"> Cuerpo </h5> <p class="description">A/B </p>' +
'<h5 class="subTitle"> Número de Cabinas </h5> <p class="description"> 6 </p>' +
'<h5 class="subTitle"> Condición </h5> <p class="description"> FUNCIONAL </p>' +
'<h5 class="subTitle"> Latitud_Ini </h5> <p class="description">16° 51  47.29"N</p>' +
'<h5 class="subTitle"> Longitud_Ini </h5> <p class="description"> 93° 24  24.8"W</p>' +
'<h5 class="subTitle"> Altitud </h5> <p class="description"> 923.35 </p>' +
'<a class="hvr-bounce-to-right" onClick="back()"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar.</a>'+
'</div>', 
16.86313611,
-93.40688889,
   ...
   var panoramaOptions = {
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
            ...
            jQuery('#noSelect').css('visibility', 'visible');
            jQuery('#noSelect').empty();
            jQuery('#noSelect').append(locations[i][0]);
            map.setZoom(16);
...
function back() {
    ...
    map.setZoom(9);
    var center = new google.maps.LatLng(17.519428, -93.848432);
    map.panTo(center);
